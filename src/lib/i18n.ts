...
export const translations = {
  en: {
    ...
    registerError: 'Error creating account. Password must be at least 6 characters.',
  ...
  it: {
    ...
    registerError: 'Errore nella creazione dell\'account. La password deve essere di almeno 6 caratteri.',
